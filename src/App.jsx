...
export default function App() {
  ...
  const ProFileCard = ({ file, currentTier, isCompleted, onToggleProgress }) => {
    ...
    return (
      <div className={`bg-white rounded-[2rem] border-2 ${isAccessible ? (isCompleted ? 'border-emerald-300 shadow-lg' : 'border-transparent shadow-lg') : 'border-slate-100 opacity-75 bg-slate-50/50'} p-6 sm:p-8 transition-all flex flex-col h-full group relative overflow-hidden`}>
